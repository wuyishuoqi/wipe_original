...
class TrainerEvtformer(TrainerWpformer):
  """Trainer for the current weak-gated Evtformer model.
...
class TrainerEvtformerV8(TrainerWpformer):
  """Trainer for the historical fixed two-EVT v8 model."""
  pass
